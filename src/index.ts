...
function emitModelFunctions(m: Model, L: string[]): void {
  ...
  L.push(`func write${m.name}(w *specodec.Writer, obj ${m.name}) {`);
  ...
  L.push(`func decode${m.name}(r *specodec.Reader) *${m.name} {`);
  L.push(`	obj := &${m.name}{}`);
...
export async function $onEmit(context: EmitContext<EmitterOptions>) {
  ...
  for (const svc of services) {
    ...
    L.push(`// Generated by @specodec/typespec-emitter-golanglang. DO NOT EDIT.`);
    L.push(`package ${pkg}`);
    L.push("");
